...
<form class="border border-light px-4 py-3 row" action="{{ url('admin/roles/'.$roles['id']) }}" method="POST">
    @csrf
    @method("PUT")
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h3 class="h3 mb-0 text-base fw-bold">Update Role</h3>
    </div>
    <hr>
    ...
    <div class="mb-4">
        ...
        <input type="text" id="defaultSubscriptionFormPassword" class="form-control" name="role_name" value="{{$roles['role_name']}}">
    </div>
