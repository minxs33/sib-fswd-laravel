...
<form class="border border-light px-4 py-3 row" action="{{ url('admin/users') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="col-lg-6">
        ...
        <div class="mb-4">
            ...
            <input type="email" id="defaultSubscriptionFormPassword" class="form-control" name="email">
        </div>
